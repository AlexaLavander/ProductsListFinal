...
class CosmosRead : AppCompatActivity() {
    ...
    lateinit var firebaseRecyclerAdapterCat: FirebaseRecyclerAdapter<CategoryModel, CosmosCategories>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.cosmos_activity_read)

        val menuToolbar = findViewById<MaterialToolbar>(R.id.materialToolbar)
        setSupportActionBar(menuToolbar)
        window.statusBarColor = ContextCompat.getColor(this, R.color.cosmos)

        extra = intent.getStringExtra("title").toString()
        inflater = (this as Activity).getLayoutInflater()
        dialoglayout = inflater.inflate(R.layout.cosmos_alertdialog_prosuct, null)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        this.menuInflater.inflate(R.menu.cosmos_menu_back, menu)
    ...
    fun showCategories() {
        ...
        firebaseRecyclerAdapterCat =
            object :
                FirebaseRecyclerAdapter<CategoryModel, CosmosCategories>(options) {
                override fun onCreateViewHolder(
                    ...
                    val itemView = LayoutInflater.from(parent.context)
                        .inflate(R.layout.cosmos_category, parent, false)

                    return CosmosCategories(itemView, CategoryModel())
                }

                override fun onBindViewHolder(
                    holder: CosmosCategories,
                    position: Int,
                    model: CategoryModel
                ) {
                    holder.setDetails(
    ...
    fun addAlertDialog() {
        ...
        dialoglayout = inflater.inflate(R.layout.cosmos_add_partner, null)
        val alertDialog = AlertDialog.Builder(this)
