...
class CosmosNotificationsHolder(itemVIew: View, notificationModel: NatificationModel) :
    ...
    fun setDetails(username: String, imageUser: String, imageReceipt: String) {
        ...
        Picasso.get().load(imageUser).placeholder(R.drawable.baseline_account_circle_24_cosmos)
            .into(userImage)
