...
open class CosmosProductHolder(itemView: View, val productModel: ProductModel = ProductModel()) :
    ...
    fun setDetails(ctx: Context?, name: String, extra: String, category: String) {
        ...
        itemView.setOnLongClickListener() { view: View? ->
            ...
            val dialoglayout = inflater.inflate(R.layout.cosmos_delete_alert, null)
